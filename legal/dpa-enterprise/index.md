---
layout: legal
title: Data Processing Agreement (Enterprise Negotiated Template)
badge: Legal · DPA · Enterprise template
description: Bodaty LLC Enterprise-tier DPA template — GDPR Article 28, UK GDPR, Swiss FADP, EU-U.S. DPF, SCCs Module Two, EU AI Act, Colorado AI Act, on-site audit, custom residency
effective_date: On Customer countersignature (or Principal Agreement acceptance, whichever is earlier)
last_updated: May 29, 2026
version: "2.1"
sync_source: editions/enterprise/docs/DATA_PROCESSING_AGREEMENT.md
permalink: /legal/dpa-enterprise/
---
...
Looking for the **Business-tier click-through DPA** (most subscribers)? See [`/legal/dpa/`](/legal/dpa/). Looking for the **Community free-tier DPA**? See [`/legal/community-dpa/`](/legal/community-dpa/).
