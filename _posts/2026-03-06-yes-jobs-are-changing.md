---
layout: post
title: "Yes, Jobs Are Changing. Here's What's Actually Happening."
date: 2026-03-06
author: Bobby Koritala
categories: [ai, future-of-work, thought-leadership]
excerpt: "Anthropic's landmark labor market study found AI could handle 94% of computer tasks — but only 33% are actually automated. The gap tells us everything about what's really happening with AI and jobs."
---
...
Anthropic — the company behind Claude — just published what may be the most rigorous labor market study on AI to date. Their researchers developed a new metric called "observed exposure" that compares the theoretical capabilities of AI with [actual usage data from millions of real interactions](https://www.anthropic.com/research/labor-market-impacts). They didn't just theorize about what AI *could* do. They measured what it's *actually* doing.
...
Phil Fersht, founder of HFS Research and the analyst who [coined "Services-as-Software,"](https://www.linkedin.com/in/philfersht/) put it starkly: "Companies are not firing people. They are quietly closing the front door on the next generation of knowledge workers."
...
Fortune ran with ["A 'Great Recession for white-collar workers' is absolutely possible."](https://fortune.com/2026/03/06/ai-job-losses-report-anthropic-research-great-recession-for-white-collar-workers/) Axios announced that ["Anthropic launches AI job destruction detector."](https://www.axios.com/2026/03/05/anthropic-ai-jobs-claude) The framing is binary: AI replaces humans. One-for-one substitution. A robot sits in your chair and does your job.
...
AT&T demonstrated this at massive scale. Their chief data officer, Andy Markus, [told VentureBeat](https://venturebeat.com/orchestration/8-billion-tokens-a-day-forced-at-and-t-to-rethink-ai-orchestration-and-cut) that after restructuring their AI orchestration — specialized agents handling domain-specific work, with humans maintaining supervisory control and full audit trails — they achieved a 90% cost reduction and 3x throughput increase across 100,000+ employees.
...
- [Anthropic launches tool to monitor jobs lost to AI systems — Axios](https://www.axios.com/2026/03/05/anthropic-ai-jobs-claude)
