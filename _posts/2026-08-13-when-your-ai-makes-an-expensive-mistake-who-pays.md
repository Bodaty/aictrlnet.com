...
- **Why we won't give you an adoption percentage** — [Insurance Journal, 22 July 2026](https://www.insurancejournal.com/news/national/2026/07/22/878480.htm), where the coverage counsel interviewed says plainly: "Insurers are still evaluating their options in real time, so we don't know yet what each insurer is going to do."
